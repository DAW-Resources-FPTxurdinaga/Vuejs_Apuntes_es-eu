...
Ahora que tienes una introducción a Pinia, el siguiente paso es aprender sobre [Stores en Pinia](.\/6.2-stores.md), donde aprenderás a crear y utilizar stores para gestionar el estado de tu aplicación.
