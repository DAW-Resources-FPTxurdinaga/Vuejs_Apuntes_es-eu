...
## Nuevas características de Vue 3

- **Composition API**: Una forma más lógica de organizar el código
- **Mejor reactividad**: Reactividad basada en Proxy
- **Soporte para TypeScript**: Mejor integración con TypeScript
- **Fragmentos**: Múltiples nodos raíz en los componentes
- **Teleport**: Mover elementos en el DOM
- **Suspense**: Soporte para componentes asíncronos
