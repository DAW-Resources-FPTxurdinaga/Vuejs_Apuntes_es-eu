...
<template>
  <div>
    <h1>{{ $route.params.username }} erabiltzaileren profila</h1>
    <!-- Edo Composition API erabiliz -->
    <p>Erabiltzailearen IDa: {{ userId }}</p>
  </div>
  </template>
